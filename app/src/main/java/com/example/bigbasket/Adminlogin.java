    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        ...
                                        ReusableCodeForAll.ShowAlert(Adminlogin.this,"Verification Failed","You Have Not Verified Your Email");
            ...
            Forgotpassword.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Adminlogin.this,AdminForgotPassword.class));
                    finish();
                }
            });
            Signinphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Adminlogin.this,Adminloginphone.class));
                    finish();
                }
            });
        }catch (Exception e){
